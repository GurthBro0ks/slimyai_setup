...
const nodeTimeCostSum = (
  ...
  for (let i = level; i <= totalLevels; i++) {
    sum +=
      (coeff * (i + additonConstant) - negativeConstant) * timeModA -
      timeModB -
      flatTime;
  }
  return sum;
...
function costReductionCalc(buffCost, tier, row, level, btad = false) {
  ...
  if (tier === 5) {
    ...
    if (btad) {
      ...
      baseCost =
        row === 1
          ? levelCostCalc(2.5, 3, level)
          : row === 2
            ? levelCostCalc(3, 3, level)
    ...
    if (btad) {
      ...
      baseCost =
        row === 1
          ? levelCostCalc(5, 3, level)
          : row === 2
            ? levelCostCalc(8, 3, level)
    ...
    if (btad) {
      ...
      baseCost =
        row === 1
          ? levelCostCalc(20, 2, level)
          : row === 2
            ? levelCostCalc(30, 2, level)
...
function singleLevelCostHandler(
  tier,
  row,
  level,
  timeModA = 1,
...
function formT5Calc(
  ...
  if (leftNodeFirstLv < 10) {
    ...
    zombieCells += [5.4, 10, 12, 14, 16, 18, 20, 22, 24, 26]
      .slice(leftNodeFirstLv)
      .reduce((a, b) => a + b, 0);
    demonCells += dragonT5cellCostSetA
      .slice(leftNodeFirstLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (rightNodeFirstLv < 10) {
    ...
    zombieCells += dragonT5cellCostSetA
      .slice(rightNodeFirstLv)
      .reduce((a, b) => a + b, 0);
    demonCells += dragonT5cellCostSetB
      .slice(rightNodeFirstLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (leftNodeSecondLv < 10) {
    ...
    angelCells += dragonT5cellCostSetC
      .slice(leftNodeSecondLv)
      .reduce((a, b) => a + b, 0);
    mutantCells += dragonT5cellCostSetA
      .slice(leftNodeSecondLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (rightNodeSecondLv < 10) {
    ...
    angelCells += dragonT5cellCostSetC
      .slice(rightNodeSecondLv)
      .reduce((a, b) => a + b, 0);
    mechaCells += dragonT5cellCostSetA
      .slice(rightNodeSecondLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (leftNodeThirdLv < 10) {
    ...
    zombieCells += dragonT5cellCostSetB
      .slice(leftNodeThirdLv)
      .reduce((a, b) => a + b, 0);
    mechaCells += dragonT5cellCostSetD
      .slice(leftNodeThirdLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (rightNodeThirdLv < 10) {
    ...
    demonCells += dragonT5cellCostSetB
      .slice(rightNodeThirdLv)
      .reduce((a, b) => a + b, 0);
    mutantCells += dragonT5cellCostSetD
      .slice(rightNodeThirdLv)
      .reduce((a, b) => a + b, 0);
  }
...
function formT6Calc(
  ...
  if (leftNodeFirstLv < 10) {
    ...
    zombieCells += [5.4, 10, 12, 14, 16, 18, 20, 22, 24, 26]
      .slice(leftNodeFirstLv)
      .reduce((a, b) => a + b, 0);
    demonCells += dragonT6cellCostSetA
      .slice(leftNodeFirstLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (rightNodeFirstLv < 10) {
    ...
    formCells += nodeCostSum(2.5, 3, rightNodeFirstLv);
    zombieCells += dragonT6cellCostSetA
      .slice(rightNodeFirstLv)
      .reduce((a, b) => a + b, 0);
    demonCells += dragonT6cellCostSetB
      .slice(rightNodeFirstLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (leftNodeSecondLv < 10) {
    ...
    formCells += nodeCostSum(3, 3, leftNodeSecondLv);
    angelCells += dragonT6cellCostSetC
      .slice(leftNodeSecondLv)
      .reduce((a, b) => a + b, 0);
    mutantCells += dragonT6cellCostSetA
      .slice(leftNodeSecondLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (rightNodeSecondLv < 10) {
    ...
    angelCells += dragonT6cellCostSetC
      .slice(rightNodeSecondLv)
      .reduce((a, b) => a + b, 0);
    mechaCells += dragonT6cellCostSetA
      .slice(rightNodeSecondLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (leftNodeThirdLv < 10) {
    ...
    formCells += nodeCostSum(4, 3, leftNodeThirdLv);
    zombieCells += dragonT6cellCostSetB
      .slice(leftNodeThirdLv)
      .reduce((a, b) => a + b, 0);
    mechaCells += dragonT6cellCostSetD
      .slice(leftNodeThirdLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (rightNodeThirdLv < 10) {
    ...
    demonCells += dragonT6cellCostSetB
      .slice(rightNodeThirdLv)
      .reduce((a, b) => a + b, 0);
    mutantCells += dragonT6cellCostSetD
      .slice(rightNodeThirdLv)
      .reduce((a, b) => a + b, 0);
  }
...
function formT7Calc(
  ...
  if (leftNodeFirstLv < 10) {
    ...
    zombieCells += [45, 56, 67, 78, 90, 100, 110, 120, 130, 140]
      .slice(leftNodeFirstLv)
      .reduce((a, b) => a + b, 0);
    demonCells += [30, 37, 45, 52, 60, 67, 75, 82, 90, 97]
      .slice(leftNodeFirstLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (rightNodeFirstLv < 10) {
    ...
    zombieCells += [30, 37, 45, 52, 60, 67, 75, 82, 90, 97]
      .slice(rightNodeFirstLv)
      .reduce((a, b) => a + b, 0);
    demonCells += [43, 54, 65, 75, 89, 97, 100, 110, 130, 140]
      .slice(rightNodeFirstLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (leftNodeSecondLv < 10) {
    ...
    angelCells += [63, 78, 94, 110, 120, 140, 150, 170, 180, 200]
      .slice(leftNodeSecondLv)
      .reduce((a, b) => a + b, 0);
    mutantCells += [30, 37, 45, 52, 60, 67, 75, 82, 90, 97]
      .slice(leftNodeSecondLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (rightNodeSecondLv < 10) {
    ...
    angelCells += [63, 78, 94, 110, 120, 140, 150, 170, 180, 200]
      .slice(rightNodeSecondLv)
      .reduce((a, b) => a + b, 0);
    mechaCells += [31, 39, 47, 55, 63, 71, 78, 86, 94, 10]
      .slice(rightNodeSecondLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (leftNodeThirdLv < 10) {
    ...
    zombieCells += [45, 56, 67, 78, 90, 100, 110, 120, 130, 140]
      .slice(leftNodeThirdLv)
      .reduce((a, b) => a + b, 0);
    mechaCells += [90, 110, 130, 150, 180, 200, 220, 240, 270, 290]
      .slice(leftNodeThirdLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (rightNodeThirdLv < 10) {
    ...
    demonCells += [45, 56, 67, 78, 90, 100, 110, 120, 130, 140]
      .slice(rightNodeThirdLv)
      .reduce((a, b) => a + b, 0);
    mutantCells += [90, 110, 130, 150, 180, 200, 220, 240, 270, 290]
      .slice(rightNodeThirdLv)
      .reduce((a, b) => a + b, 0);
  }
...
function formT8Calc(
  ...
  if (leftNodeFirstLv < 10) {
    ...
    zombieCells += [120, 160, 200, 240, 280, 320, 360, 400, 440, 480]
      .slice(leftNodeFirstLv)
      .reduce((a, b) => a + b, 0);
    demonCells += [81, 100, 130, 160, 180, 210, 240, 270, 290, 320]
      .slice(leftNodeFirstLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (rightNodeFirstLv < 10) {
    ...
    zombieCells += [81, 100, 130, 160, 180, 210, 240, 270, 290, 320]
      .slice(rightNodeFirstLv)
      .reduce((a, b) => a + b, 0);
    demonCells += [120, 160, 200, 240, 280, 320, 360, 400, 440, 480]
      .slice(rightNodeFirstLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (leftNodeSecondLv < 10) {
    ...
    angelCells += [180, 220, 280, 340, 390, 450, 510, 560, 620, 680]
      .slice(leftNodeSecondLv)
      .reduce((a, b) => a + b, 0);
    mutantCells += [77, 100, 120, 150, 180, 200, 230, 250, 280, 300]
      .slice(leftNodeSecondLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (compassNodeLv < 5) {
    ...
    angelCells += [300, 400, 500, 600, 900]
      .slice(compassNodeLv)
      .reduce((a, b) => a + b, 0);
    mutantCells += [300, 400, 500, 600, 900]
      .slice(compassNodeLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (rightNodeSecondLv < 10) {
    ...
    angelCells += [180, 240, 300, 360, 420, 480, 540, 600, 660, 720]
      .slice(rightNodeSecondLv)
      .reduce((a, b) => a + b, 0);
    mechaCells += [120, 170, 210, 250, 300, 340, 380, 430, 470, 510]
      .slice(rightNodeSecondLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (leftNodeThirdLv < 10) {
    ...
    zombieCells += [110, 150, 190, 230, 270, 310, 350, 390, 430, 470]
      .slice(leftNodeThirdLv)
      .reduce((a, b) => a + b, 0);
    mechaCells += [240, 320, 400, 480, 560, 640, 720, 810, 890, 970]
      .slice(leftNodeThirdLv)
      .reduce((a, b) => a + b, 0);
  }
  ...
  if (rightNodeThirdLv < 10) {
    ...
    demonCells += [120, 160, 200, 240, 280, 320, 360, 400, 440, 480]
      .slice(rightNodeThirdLv)
      .reduce((a, b) => a + b, 0);
    mutantCells += [240, 320, 400, 480, 560, 640, 720, 800, 880, 960]
      .slice(rightNodeThirdLv)
      .reduce((a, b) => a + b, 0);
  }
